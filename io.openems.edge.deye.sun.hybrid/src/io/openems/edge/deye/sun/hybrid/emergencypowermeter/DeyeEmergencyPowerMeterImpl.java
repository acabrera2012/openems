package io.openems.edge.deye.sun.hybrid.emergencypowermeter;
...
public class DeyeEmergencyPowerMeterImpl extends AbstractOpenemsModbusComponent implements DeyeEmergencyPowerMeter,
	...
	public DeyeEmergencyPowerMeterImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				ElectricityMeter.ChannelId.values(), //
				DeyeEmergencyPowerMeter.ChannelId.values() //
		);
		...
		return new ModbusProtocol(this, //
				...
				new FC3ReadRegistersTask(35145, Priority.HIGH, //
						...
						m(ElectricityMeter.ChannelId.CURRENT_L1, new UnsignedWordElement(35146), //
								SCALE_FACTOR_2), //
						m(DeyeEmergencyPowerMeter.ChannelId.FREQUENCY_L1, new UnsignedWordElement(35147), //
						...
						m(ElectricityMeter.ChannelId.CURRENT_L2, new UnsignedWordElement(35152), //
								SCALE_FACTOR_2), //
						m(DeyeEmergencyPowerMeter.ChannelId.FREQUENCY_L2, new UnsignedWordElement(35153), //
								SCALE_FACTOR_MINUS_2), //
						...
						m(ElectricityMeter.ChannelId.CURRENT_L3, new UnsignedWordElement(35158), //
								SCALE_FACTOR_2), //
						m(DeyeEmergencyPowerMeter.ChannelId.FREQUENCY_L3, new UnsignedWordElement(35159), //
								SCALE_FACTOR_MINUS_2), //
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(DeyeEmergencyPowerMeter.class, accessMode, 100).build() //
		);
	}
