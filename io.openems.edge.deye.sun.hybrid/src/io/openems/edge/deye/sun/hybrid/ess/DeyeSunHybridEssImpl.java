...
import io.openems.edge.deye.sun.hybrid.ErrorChannelId;
import io.openems.edge.deye.sun.hybrid.core.DeyeSunHybridCore;
...
public class DeyeSunHybridEssImpl extends AbstractOpenemsComponent implements DeyeSunHybridEss,
	...
	private DeyeSunHybridCore core;
	...
	public DeyeSunHybridEssImpl() {
		super(//
				...
				DeyeSunHybridEss.ChannelId.values() //
		);
	}
	...
	private void updateChannels() {
		...
		this.channel(DeyeSunHybridEss.ChannelId.BMS_VOLTAGE).setNextValue(bmsVoltage);
		this.channel(DeyeSunHybridEss.ChannelId.RISO).setNextValue(riso);
		this.channel(DeyeSunHybridEss.ChannelId.INVERTER_STATUS).setNextValue(inverterStatus);
		this.channel(DeyeSunHybridEss.ChannelId.BATTERY_STATUS).setNextValue(batteryStatus);
		this.channel(DeyeSunHybridEss.ChannelId.POWER_MANAGEMENT_CONFIGURATION)
	...
	public void applyPower(int activePower, int reactivePower) {
		...
		case VERSION_8:
			if (!this.config.readOnly() //
				...
				this._setUserPasswordNotChangedWithExternalDeyeVersion8(true);
				return;
			}
			break;
		case UNDEFINED:
		case VERSION_7_OR_OLDER:
			this._setUserPasswordNotChangedWithExternalDeyeVersion8(false);
			break;
		}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(DeyeSunHybridEss.class, accessMode, 100) //
						.build());
	}
}
