package io.openems.edge.deye.charger.twostring;
...
public class RuleOfThreeTest {
	...
	public void calculateByRuleOfThreeTest() {
		...
		Integer result = DeyeChargerTwoString.calculateByRuleOfThree(totalValue, divisor, value1).orElse(0);
		...
		Integer result2 = DeyeChargerTwoString.calculateByRuleOfThree(totalValue, divisor, value2).orElse(0);
	...
	public void calculateByRuleOfThreeWithZeroDivisorTest() {
		...
		var resultIsPresent = DeyeChargerTwoString.calculateByRuleOfThree(totalValue, divisor, value).isPresent();
	...
	public void calculateByRuleOfThreeWithGreaterResultTest() {
		...
		Integer result = DeyeChargerTwoString.calculateByRuleOfThree(totalValue, divisor, value).orElse(0);
