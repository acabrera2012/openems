...
public abstract class AbstractDeyeCharger extends AbstractOpenemsModbusComponent implements DeyeCharger,
		EssDcCharger, ModbusComponent, OpenemsComponent, TimedataProvider, EventHandler, ModbusSlave {

	protected abstract Deye getEssOrBatteryInverter();

	private final CalculateEnergyFromPower calculateActualEnergy = new CalculateEnergyFromPower(this,
			EssDcCharger.ChannelId.ACTUAL_ENERGY);

	protected AbstractDeyeCharger() {
		super(//
	...
	protected AbstractDeyeCharger(io.openems.edge.common.channel.ChannelId[] firstInitialChannelIds,
	...
	private void updateState() {
		var deye = this.getEssOrBatteryInverter();
		Boolean hasNoDcPv = null;
		if (deye != null) {
			switch (deye.getDeyeType().getSeries()) {
			case BT:
				hasNoDcPv = true;
				break;
			case ET:
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(DeyeCharger.class, accessMode, 100) //
						.build());
	}
}
