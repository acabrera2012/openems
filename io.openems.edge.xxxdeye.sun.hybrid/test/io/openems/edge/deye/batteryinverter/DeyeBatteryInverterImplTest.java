...
import io.openems.edge.deye.sun.hybrid.charger.twostring.DeyeChargerTwoStringImpl;
import io.openems.edge.deye.sun.hybrid.charger.twostring.PvPort;
...
import io.openems.edge.deye.sun.hybrid.common.enums.FeedInPowerSettings;
...
public class DeyeBatteryInverterImplTest {
	...
	public void testEt() throws Exception {
		...
		var ess = new DeyeBatteryInverterImpl();
	...
	public void testTwoStringCharger() throws Exception {
		var ess = new DeyeBatteryInverterImpl();
		var charger1 = new DeyeChargerTwoStringImpl();
		var charger2 = new DeyeChargerTwoStringImpl();
		var charger3 = new DeyeChargerTwoStringImpl();
		var charger4 = new DeyeChargerTwoStringImpl();
		var charger5 = new DeyeChargerTwoStringImpl();
		var charger6 = new DeyeChargerTwoStringImpl();

		new ComponentTest(charger1) //
				.addReference("cm", new DummyConfigurationAdmin()) //
				.addReference("essOrBatteryInverter", ess) //
				.activate(io.openems.edge.deye.charger.twostring.MyConfig.create() //
						.setId(CHARGER_ID) //
						.setBatteryInverterId(BATTERY_INVERTER_ID) //
