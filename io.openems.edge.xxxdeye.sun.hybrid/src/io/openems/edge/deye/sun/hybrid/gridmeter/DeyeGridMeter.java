...
public interface DeyeGridMeter extends ElectricityMeter, OpenemsComponent {
	...
	public static enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		HAS_NO_METER(Doc.of(Level.INFO) //
				.text("This Deye has no Grid-Meter. Meter can be deleted or hardware must be checked.")),
