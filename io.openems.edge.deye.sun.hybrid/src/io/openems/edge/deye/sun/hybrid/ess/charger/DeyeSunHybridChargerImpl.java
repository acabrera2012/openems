...
public class DeyeSunHybridChargerImpl extends AbstractOpenemsComponent implements
		DeyeSunHybridCharger, EssDcCharger, OpenemsComponent, TimedataProvider, EventHandler, ModbusSlave {
	...
	public DeyeSunHybridChargerImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				EssDcCharger.ChannelId.values(), //
				DeyeSunHybridCharger.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(DeyeSunHybridCharger.class, accessMode, 100) //
						.build());
	}
}
