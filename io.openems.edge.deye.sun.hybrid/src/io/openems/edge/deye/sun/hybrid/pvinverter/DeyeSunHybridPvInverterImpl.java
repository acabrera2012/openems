...
@Component(//
		name = "Deye.SunHybrid.PvInverter", //
		immediate = true, //
...
public class DeyeSunHybridPvInverterImpl extends AbstractOpenemsComponent
		implements DeyeSunHybridPvInverter, ManagedSymmetricPvInverter, ElectricityMeter, OpenemsComponent,
		TimedataProvider, EventHandler, ModbusSlave {

	private final Logger log = LoggerFactory.getLogger(DeyeSunHybridPvInverterImpl.class);
	...
	protected DeyeSunHybridCore core;
	...
	public DeyeSunHybridPvInverterImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ElectricityMeter.ChannelId.values(), //
				ManagedSymmetricPvInverter.ChannelId.values(), //
				ErrorChannelId.values(), //
				DeyeSunHybridPvInverter.ChannelId.values() //
		);
		this._setMaxApparentPower(DeyeSunHybridPvInverter.MAX_APPARENT_POWER);
	...
	public void handleEvent(Event event) {
		...
		case EdgeEventConstants.TOPIC_CYCLE_EXECUTE_WRITE:
			try {
				...
				this.channel(DeyeSunHybridPvInverter.ChannelId.PV_LIMIT_FAILED).setNextValue(false);
			} catch (OpenemsNamedException e) {
				this.channel(DeyeSunHybridPvInverter.ChannelId.PV_LIMIT_FAILED).setNextValue(true);
			}
			break;
		}
	}
	...
	private void updateChannels() {
		...
		if (bpData != null) {
			...
			activePowerLimit = (int) (DeyeSunHybridPvInverter.MAX_APPARENT_POWER * eplimitPerc);
