...
public class DeyeGridMeterImpl extends AbstractOpenemsModbusComponent implements DeyeGridMeter, ElectricityMeter,
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		var protocol = new ModbusProtocol(this, //
				...
				new FC3ReadRegistersTask(36003, Priority.LOW,
						...
						m(DeyeGridMeter.ChannelId.HAS_NO_METER, new UnsignedWordElement(36004),
				...
				new FC3ReadRegistersTask(35123, Priority.LOW, //
						m(DeyeGridMeter.ChannelId.F_GRID_R, new UnsignedWordElement(35123), SCALE_FACTOR_MINUS_2), // //
						new DummyRegisterElement(35124, 35127), //
						m(DeyeGridMeter.ChannelId.F_GRID_S, new UnsignedWordElement(35128), SCALE_FACTOR_MINUS_2),
						new DummyRegisterElement(35129, 35132),
						m(DeyeGridMeter.ChannelId.F_GRID_T, new UnsignedWordElement(35133), SCALE_FACTOR_MINUS_2), //
						m(DeyeGridMeter.ChannelId.P_GRID_T, new SignedDoublewordElement(35134),
				...
				new FC3ReadRegistersTask(36005, Priority.HIGH, //
						...
						m(DeyeGridMeter.ChannelId.METER_POWER_FACTOR, new UnsignedWordElement(36013),
								SCALE_FACTOR_MINUS_2), //
	...
	public void convertMeterConnectStatus(Integer value) {
		if (value == null) {
			value = 0x0;
		}
		this.updateMeterConnectStatus(//
				DeyeGridMeter.ChannelId.METER_CON_CORRECTLY_L1, //
				DeyeGridMeter.ChannelId.METER_CON_INCORRECTLY_L1, //
				DeyeGridMeter.ChannelId.METER_CON_REVERSE_L1, //
				DeyeGridMeterImpl.getPhaseConnectionValue(Phase.L1, value));

		this.updateMeterConnectStatus(//
				DeyeGridMeter.ChannelId.METER_CON_CORRECTLY_L2, //
				DeyeGridMeter.ChannelId.METER_CON_INCORRECTLY_L2, //
				DeyeGridMeter.ChannelId.METER_CON_REVERSE_L2, //
				DeyeGridMeterImpl.getPhaseConnectionValue(Phase.L2, value));

		this.updateMeterConnectStatus(//
				DeyeGridMeter.ChannelId.METER_CON_CORRECTLY_L3, //
				DeyeGridMeter.ChannelId.METER_CON_INCORRECTLY_L3, //
				DeyeGridMeter.ChannelId.METER_CON_REVERSE_L3, //
				DeyeGridMeterImpl.getPhaseConnectionValue(Phase.L3, value));
	}
	 ...
	 */
	public static Integer getPhaseConnectionValue(Phase phase, int value) {
		switch (phase) {
		case L1:
			return value & 0xF;
		case L2:
	 ...
	 * @param value              value
	 */
	private void updateMeterConnectStatus(DeyeGridMeter.ChannelId correctlyChannel,
			DeyeGridMeter.ChannelId incorrectlyChannel, DeyeGridMeter.ChannelId reverseChannel, Integer value) {
