...
public enum DeyeType implements OptionsEnum {
	UNDEFINED(-1, "Undefined", Series.UNDEFINED, 25), //
	DEYE_10K_BT(10, "Deye GW10K-BT", Series.BT, 25), //
	DEYE_8K_BT(11, "Deye GW8K-BT", Series.BT, 25), //
	DEYE_5K_BT(12, "Deye GW5K-BT", Series.BT, 25), //
	DEYE_10K_ET(20, "Deye GW10K-ET", Series.ET, 25), //
	DEYE_8K_ET(21, "Deye GW8K-ET", Series.ET, 25), //
	DEYE_5K_ET(22, "Deye GW5K-ET", Series.ET, 25), //
	...
	private DeyeType(int value, String option, Series series, int maxDcCurrent,
	...
	/**
	 * Is this Deye a ET-Series or BT-Series.
	 *
