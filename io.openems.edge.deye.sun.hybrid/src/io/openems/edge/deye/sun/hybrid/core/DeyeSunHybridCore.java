...
public interface DeyeSunHybridCore extends OpenemsComponent {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		USER_ACCESS_DENIED(Doc.of(Level.FAULT) //
				/*
				 * Additional text when we are able to ensure the functionality of the external mode
				 */
				.text("Deye user access denied.")), //
		MULTIPLE_ACCESS(Doc.of(Level.FAULT) //
				.text("Deye is read by multiple devices. Authentication might fail because Deye is not able to handle multiple requests")), //
