...
public interface DeyeChargerTwoString extends OpenemsComponent, EssDcCharger, DeyeCharger {
	...
	/**
	 * Used PV port of the Deye inverter.
	 * 
	 * @return Used PV port
	 */
		...
		total.ifPresent(totalValue -> {
			divisor.ifPresent(divisorValue -> {
				related.ifPresent(relatedValue -> {
					 ...
					 * 
					 * TODO: Remove it if it has been fixed by Deye
					 */
