...
import io.openems.edge.deye.sun.hybrid.BatteryStatus;
import io.openems.edge.deye.sun.hybrid.InverterStatus;

public interface DeyeSunHybridEss extends OpenemsComponent {
	...
	public static enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		/**
		 * To be able to set Set-Points on Deye inverter starting from firmware version
		 * 8, it is required to change the user password to something different
		 */
		EXTERNAL_CONTROL_FAULT_VERSION_8(Doc.of(Level.FAULT) //
				.text("Starting with Firmware Version 8 Deye inverter cannot be controlled via OpenEMS")),
	 ...
	 * @return the Channel
	 */
	public default StateChannel getUserPasswordNotChangedWithExternalDeyeVersion8() {
	 ...
	 * @param value the next value
	 */
	public default void _setUserPasswordNotChangedWithExternalDeyeVersion8(boolean value) {
		this.getUserPasswordNotChangedWithExternalDeyeVersion8().setNextValue(value);
	}
