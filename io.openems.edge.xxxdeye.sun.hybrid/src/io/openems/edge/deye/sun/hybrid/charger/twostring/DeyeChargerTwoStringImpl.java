...
public class DeyeChargerTwoStringImpl extends AbstractOpenemsComponent implements DeyeChargerTwoString,
		EssDcCharger, DeyeCharger, OpenemsComponent, EventHandler, TimedataProvider, ModbusSlave {
	...
	public DeyeChargerTwoStringImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				EssDcCharger.ChannelId.values(), //
				DeyeCharger.ChannelId.values(), //
				DeyeChargerTwoString.ChannelId.values() //
		);
	}
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(DeyeChargerTwoString.class, accessMode, 100) //
						.build());
	}
