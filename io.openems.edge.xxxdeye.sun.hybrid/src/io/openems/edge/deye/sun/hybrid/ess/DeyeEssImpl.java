...
public class DeyeEssImpl extends AbstractDeye implements DeyeEss, Deye, HybridEss, ManagedSymmetricEss,
	...
	public DeyeEssImpl() throws OpenemsNamedException {
		super(//
	...
	public ModbusSlaveTable getModbusSlaveTable(AccessMode accessMode) {
		return new ModbusSlaveTable(//
				...
				ModbusSlaveNatureTable.of(DeyeEss.class, accessMode, 100) //
						.build());
	}
}
