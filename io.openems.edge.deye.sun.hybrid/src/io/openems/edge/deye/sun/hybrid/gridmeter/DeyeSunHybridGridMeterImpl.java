...
public class DeyeSunHybridGridMeterImpl extends AbstractOpenemsComponent
		implements DeyeSunHybridGridMeter, ElectricityMeter, OpenemsComponent, TimedataProvider, EventHandler {
	...
	public DeyeSunHybridGridMeterImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ElectricityMeter.ChannelId.values(), //
				DeyeSunHybridGridMeter.ChannelId.values() //
		);
	}
