...
import io.openems.edge.deye.sun.hybrid.common.enums.ArcSelfCheckStatus;
...
import io.openems.edge.deye.sun.hybrid.common.enums.ComMode;
import io.openems.edge.deye.sun.hybrid.common.enums.CpldWarningCode;
import io.openems.edge.deye.sun.hybrid.common.enums.DredCmd;
import io.openems.edge.deye.sun.hybrid.common.enums.DredOffgridCheck;
import io.openems.edge.deye.sun.hybrid.common.enums.EhBatteryFunctionActive;
import io.openems.edge.deye.sun.hybrid.common.enums.EmsCheck;
...
import io.openems.edge.deye.sun.hybrid.common.enums.ExternalEmsFlag;
import io.openems.edge.deye.sun.hybrid.common.enums.EzloggerProCommStatus;
import io.openems.edge.deye.sun.hybrid.common.enums.DeyeGridMeterType;
import io.openems.edge.deye.sun.hybrid.common.enums.DeyeType;
import io.openems.edge.deye.sun.hybrid.common.enums.GridProtect;
import io.openems.edge.deye.sun.hybrid.common.enums.GridWaveCheckLevel;
import io.openems.edge.deye.sun.hybrid.common.enums.LedState;
import io.openems.edge.deye.sun.hybrid.common.enums.LoadMode;
import io.openems.edge.deye.sun.hybrid.common.enums.LoadRegulationIndex;
import io.openems.edge.deye.sun.hybrid.common.enums.MeterCommunicateStatus;
import io.openems.edge.deye.sun.hybrid.common.enums.MeterConnectCheckFlag;
import io.openems.edge.deye.sun.hybrid.common.enums.OperationMode;
import io.openems.edge.deye.sun.hybrid.common.enums.OutputTypeAC;
import io.openems.edge.deye.sun.hybrid.common.enums.PvMode;
import io.openems.edge.deye.sun.hybrid.common.enums.SafetyCountry;
import io.openems.edge.deye.sun.hybrid.common.enums.UpsStandartVoltType;
import io.openems.edge.deye.sun.hybrid.common.enums.WifiOrLan;
import io.openems.edge.deye.sun.hybrid.common.enums.WorkMode;
import io.openems.edge.deye.sun.hybrid.common.enums.WorkWeek;
import io.openems.edge.deye.sun.hybrid.common.enums.ZvrtConfig;
import io.openems.edge.deye.sun.hybrid.common.enums.FeedInPowerSettings.FixedPowerFactor;

public interface Deye extends OpenemsComponent {

	/**
	 * Registers a Deye Charger.
	 *
	 * @param charger {@link DeyeCharger} charger
	 */
	public void addCharger(DeyeCharger charger);

	/**
	 * Unregisters a Deye Charger.
	 *
	 * @param charger {@link DeyeCharger} charger
	 */
	public void removeCharger(DeyeCharger charger);
	...
	public static enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		METER_TYPE(Doc.of(DeyeGridMeterType.values())), //
		...
		MODBUS_BAUDRATE(Doc.of(OpenemsType.INTEGER) //
				.accessMode(AccessMode.READ_WRITE)), //
		DEYE_TYPE(Doc.of(DeyeType.values())), //
		...
		NO_SMART_METER_DETECTED(Doc.of(Level.WARNING) //
				.text("No Deye Smart Meter detected. Only REMOTE mode can work correctly")),
	...
	/**
	 * Gets the Channel for {@link ChannelId#DEYE_TYPE}.
	 *
	 * @return the Channel
	 */
	public default Channel<DeyeType> getDeyeTypeChannel() {
		return this.channel(Deye.ChannelId.DEYE_TYPE);
	}

	/**
	 * Gets the Device Type. See {@link ChannelId#DEYE_TYPE}.
	 *
	 * @return the Channel {@link Value}
	 */
	public default DeyeType getDeyeType() {
		return this.getDeyeTypeChannel().value().asEnum();
	}

	/**
	 * Internal method to set the 'nextValue' on {@link ChannelId#DEYE_TYPE}
	 * Channel.
	 *
	 * @param value the next value
	 */
	public default void _setDeyeType(DeyeType value) {
		this.getDeyeTypeChannel().setNextValue(value);
	}
