package io.openems.edge.deye.sun.hybrid.charger.singlestring;
...
import io.openems.edge.deye.sun.hybrid.charger.AbstractDeyeCharger;
...
public class DeyeChargerPv2 extends AbstractDeyeCharger
		implements DeyeCharger, EssDcCharger, ModbusComponent, OpenemsComponent, EventHandler, TimedataProvider {

	@Reference
	private ConfigurationAdmin cm;

	@Reference(policy = ReferencePolicy.STATIC, policyOption = ReferencePolicyOption.GREEDY, cardinality = ReferenceCardinality.MANDATORY)
	private Deye essOrBatteryInverter;
	...
	@Override
	protected Deye getEssOrBatteryInverter() {
